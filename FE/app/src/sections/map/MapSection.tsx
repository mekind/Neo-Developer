...
export function MapSection({ agents, lpcSpriteCatalog, onAgentInteraction }: MapSectionProps) {
  return (
    <section className="world-stage world-stage--game-only panel-shell" aria-label="world stage">
      <WorldCanvas agents={agents} lpcSpriteCatalog={lpcSpriteCatalog} onAgentInteraction={onAgentInteraction} />
    </section>
  )
}
